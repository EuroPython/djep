...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sponsor.custom_logo_size_listing'
        db.add_column(u'sponsorship_sponsor', 'custom_logo_size_listing',
                      self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sponsor.custom_logo_size_listing'
        db.delete_column(u'sponsorship_sponsor', 'custom_logo_size_listing')
