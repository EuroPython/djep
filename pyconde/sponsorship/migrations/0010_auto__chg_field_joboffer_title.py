...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobOffer.title'
        db.alter_column(u'sponsorship_joboffer', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'JobOffer.title'
        db.alter_column(u'sponsorship_joboffer', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'sponsorship.joboffer': {
            'Meta': {'ordering': "('sponsor__level__order', '-added')", 'object_name': 'JobOffer'},
