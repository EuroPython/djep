...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.num_accompanying_children'
        db.add_column('accounts_profile', 'num_accompanying_children',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.num_accompanying_children'
        db.delete_column('accounts_profile', 'num_accompanying_children')
