...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.organisation'
        db.add_column('accounts_profile', 'organisation',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.organisation'
        db.delete_column('accounts_profile', 'organisation')
