...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BadgeStatus'
        db.create_table(u'accounts_badgestatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal(u'accounts', ['BadgeStatus'])

        # Deleting field 'Profile.badge_status'
        db.delete_column(u'accounts_profile', 'badge_status')

        # Adding M2M table for field badge_status on 'Profile'
        m2m_table_name = db.shorten_name(u'accounts_profile_badge_status')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm[u'accounts.profile'], null=False)),
            ('badgestatus', models.ForeignKey(orm[u'accounts.badgestatus'], null=False))
        ))
        db.create_unique(m2m_table_name, ['profile_id', 'badgestatus_id'])

        # Deleting field 'StaffListPlugin.badge_status'
        db.delete_column(u'cmsplugin_stafflistplugin', 'badge_status')

        # Adding M2M table for field badge_status on 'StaffListPlugin'
        m2m_table_name = db.shorten_name(u'accounts_stafflistplugin_badge_status')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('stafflistplugin', models.ForeignKey(orm[u'accounts.stafflistplugin'], null=False)),
            ('badgestatus', models.ForeignKey(orm[u'accounts.badgestatus'], null=False))
        ))
        db.create_unique(m2m_table_name, ['stafflistplugin_id', 'badgestatus_id'])


    def backwards(self, orm):
        # Deleting model 'BadgeStatus'
        db.delete_table(u'accounts_badgestatus')

        # Adding field 'Profile.badge_status'
        db.add_column(u'accounts_profile', 'badge_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Removing M2M table for field badge_status on 'Profile'
        db.delete_table(db.shorten_name(u'accounts_profile_badge_status'))

        # Adding field 'StaffListPlugin.badge_status'
        db.add_column(u'cmsplugin_stafflistplugin', 'badge_status',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Removing M2M table for field badge_status on 'StaffListPlugin'
        db.delete_table(db.shorten_name(u'accounts_stafflistplugin_badge_status'))


    models = {
        u'accounts.badgestatus': {
            'Meta': {'ordering': "('name',)", 'object_name': 'BadgeStatus'},
        ...
        u'accounts.profile': {
            ...
            'accept_ep_conferences': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'accept_job_offers': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'accept_pysv_conferences': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'addressed_as': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'age_accompanying_children': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'avatar': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'badge_status': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'profiles'", 'blank': 'True', 'to': u"orm['accounts.BadgeStatus']"}),
            ...
            'organisation': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'sessions_attending': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'attendees'", 'blank': 'True', 'to': u"orm['schedule.Session']"}),
            'short_info': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'sponsor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sponsorship.Sponsor']", 'null': 'True', 'blank': 'True'}),
            'twitter': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'profile'", 'unique': 'True', 'to': u"orm['auth.User']"}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'})
        },
        u'accounts.stafflistplugin': {
            'Meta': {'object_name': 'StaffListPlugin', 'db_table': "u'cmsplugin_stafflistplugin'", '_ormbases': ['cms.CMSPlugin']},
            'additional_names': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'badge_status': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['accounts.BadgeStatus']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        u'schedule.session': {
            ...
            'max_attendees': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
