...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_stafflistplugin', (
            ...
            ('badge_status', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
    ...
    models = {
        u'accounts.profile': {
            ...
            'badge_status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
        ...
        u'accounts.stafflistplugin': {
            ...
            'badge_status': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
