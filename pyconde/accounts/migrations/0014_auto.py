...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field trainings on 'Profile'
        db.delete_table(db.shorten_name(u'accounts_profile_trainings'))

        # Adding M2M table for field sessions_attending on 'Profile'
        m2m_table_name = db.shorten_name(u'accounts_profile_sessions_attending')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field sessions_attending on 'Profile'
        db.delete_table(db.shorten_name(u'accounts_profile_sessions_attending'))
