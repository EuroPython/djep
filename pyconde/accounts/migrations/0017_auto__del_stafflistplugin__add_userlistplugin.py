...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'cmsplugin_stafflistplugin')
        ...
        # Adding model 'UserListPlugin'
        db.create_table(u'cmsplugin_userlistplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('additional_names', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal(u'accounts', ['UserListPlugin'])

        # Adding M2M table for field badge_status on 'UserListPlugin'
        m2m_table_name = db.shorten_name(u'accounts_userlistplugin_badge_status')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userlistplugin', models.ForeignKey(orm[u'accounts.userlistplugin'], null=False)),
            ('badgestatus', models.ForeignKey(orm[u'accounts.badgestatus'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userlistplugin_id', 'badgestatus_id'])


    def backwards(self, orm):
        # Adding model 'StaffListPlugin'
        db.create_table(u'cmsplugin_stafflistplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('additional_names', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal(u'accounts', ['StaffListPlugin'])
        ...
        # Deleting model 'UserListPlugin'
        db.delete_table(u'cmsplugin_userlistplugin')

        # Removing M2M table for field badge_status on 'UserListPlugin'
        db.delete_table(db.shorten_name(u'accounts_userlistplugin_badge_status'))
    ...
    models = {
        ...
        u'accounts.userlistplugin': {
            'Meta': {'object_name': 'UserListPlugin', 'db_table': "u'cmsplugin_userlistplugin'", '_ormbases': ['cms.CMSPlugin']},
