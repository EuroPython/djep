...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.sponsor'
        db.delete_column(u'accounts_profile', 'sponsor_id')


    def backwards(self, orm):
        # Adding field 'Profile.sponsor'
        db.add_column(u'accounts_profile', 'sponsor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sponsorship.Sponsor'], null=True, blank=True),
                      keep_default=False)
