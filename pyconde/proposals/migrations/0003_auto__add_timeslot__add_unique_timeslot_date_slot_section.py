...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('proposals_timeslot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('slot', self.gf('django.db.models.fields.IntegerField')()),
            ('section', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Section'])),
        ))
        db.send_create_signal('proposals', ['TimeSlot'])

        # Adding unique constraint on 'TimeSlot', fields ['date', 'slot', 'section']
        db.create_unique('proposals_timeslot', ['date', 'slot', 'section_id'])

        # Adding M2M table for field available_timeslots on 'Proposal'
        db.create_table('proposals_proposal_available_timeslots', (
        ...
        db.create_unique('proposals_proposal_available_timeslots', ['proposal_id', 'timeslot_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TimeSlot', fields ['date', 'slot', 'section']
        db.delete_unique('proposals_timeslot', ['date', 'slot', 'section_id'])

        # Deleting model 'TimeSlot'
        db.delete_table('proposals_timeslot')

        # Removing M2M table for field available_timeslots on 'Proposal'
        db.delete_table('proposals_proposal_available_timeslots')
