...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProposalVersion.accept_recording'
        db.add_column(u'reviews_proposalversion', 'accept_recording',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'ProposalVersion.conference'
        db.alter_column(u'reviews_proposalversion', 'conference_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Conference'], on_delete=models.PROTECT))

        # Changing field 'ProposalVersion.kind'
        db.alter_column(u'reviews_proposalversion', 'kind_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.SessionKind'], on_delete=models.PROTECT))

        # Changing field 'ProposalVersion.track'
        db.alter_column(u'reviews_proposalversion', 'track_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Track'], null=True, on_delete=models.PROTECT))

        # Changing field 'ProposalVersion.speaker'
        db.alter_column(u'reviews_proposalversion', 'speaker_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['speakers.Speaker']))

        # Changing field 'ProposalVersion.duration'
        db.alter_column(u'reviews_proposalversion', 'duration_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.SessionDuration'], on_delete=models.PROTECT))

        # Changing field 'ProposalVersion.audience_level'
        db.alter_column(u'reviews_proposalversion', 'audience_level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.AudienceLevel'], on_delete=models.PROTECT))

    def backwards(self, orm):
        # Deleting field 'ProposalVersion.accept_recording'
        db.delete_column(u'reviews_proposalversion', 'accept_recording')


        # Changing field 'ProposalVersion.conference'
        db.alter_column(u'reviews_proposalversion', 'conference_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Conference']))

        # Changing field 'ProposalVersion.kind'
        db.alter_column(u'reviews_proposalversion', 'kind_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.SessionKind']))

        # Changing field 'ProposalVersion.track'
        db.alter_column(u'reviews_proposalversion', 'track_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Track'], null=True))

        # Changing field 'ProposalVersion.speaker'
        db.alter_column(u'reviews_proposalversion', 'speaker_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['speakers.Speaker']))

        # Changing field 'ProposalVersion.duration'
        db.alter_column(u'reviews_proposalversion', 'duration_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.SessionDuration']))

        # Changing field 'ProposalVersion.audience_level'
        db.alter_column(u'reviews_proposalversion', 'audience_level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.AudienceLevel']))
