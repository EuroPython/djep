...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProposalVersion.language'
        db.add_column('reviews_proposalversion', 'language',
                      self.gf('django.db.models.fields.CharField')(default='de', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProposalVersion.language'
        db.delete_column('reviews_proposalversion', 'language')
