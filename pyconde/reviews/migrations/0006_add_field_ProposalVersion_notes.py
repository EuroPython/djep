...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProposalVersion.notes'
        db.add_column('reviews_proposalversion', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProposalVersion.notes'
        db.delete_column('reviews_proposalversion', 'notes')
