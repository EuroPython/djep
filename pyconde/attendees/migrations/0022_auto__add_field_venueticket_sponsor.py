...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VenueTicket.sponsor'
        db.add_column(u'attendees_venueticket', 'sponsor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sponsorship.Sponsor'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VenueTicket.sponsor'
        db.delete_column(u'attendees_venueticket', 'sponsor_id')
