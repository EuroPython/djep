...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TicketType.allow_editing'
        db.alter_column(u'attendees_tickettype', 'allow_editing', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'TicketType.allow_editing'
        db.alter_column(u'attendees_tickettype', 'allow_editing', self.gf('django.db.models.fields.BooleanField')())
