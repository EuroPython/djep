...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'attendees_customer')

        # Deleting field 'Purchase.customer'
        db.delete_column(u'attendees_purchase', 'customer_id')

        # Adding field 'Purchase.email'
        db.add_column(u'attendees_purchase', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='noemail@test.com', max_length=75),
                      keep_default=False)
