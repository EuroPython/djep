...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Purchase.zip_code'
        db.alter_column(u'attendees_purchase', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Purchase.zip_code'
        db.alter_column(u'attendees_purchase', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=5))
