...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TicketType.remarks'
        db.alter_column('attendees_tickettype', 'remarks', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'TicketType.remarks'
        db.alter_column('attendees_tickettype', 'remarks', self.gf('django.db.models.fields.CharField')(max_length=254))
