...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Purchase.invoice_number'
        db.add_column(u'attendees_purchase', 'invoice_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Purchase.invoice_filename'
        db.add_column(u'attendees_purchase', 'invoice_filename',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'attendees_purchase', 'invoice_number')

        # Deleting field 'Purchase.invoice_filename'
        db.delete_column(u'attendees_purchase', 'invoice_filename')
