...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TShirtSize'
        db.create_table('attendees_tshirtsize', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sort', self.gf('django.db.models.fields.IntegerField')(default=999)),
        ))
        db.send_create_signal('attendees', ['TShirtSize'])

        # Adding field 'Ticket.shirtsize'
        db.add_column('attendees_ticket', 'shirtsize',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attendees.TShirtSize'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TShirtSize'
        db.delete_table('attendees_tshirtsize')

        # Deleting field 'Ticket.shirtsize'
        db.delete_column('attendees_ticket', 'shirtsize_id')
