...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketType.is_on_desk_active'
        db.add_column(u'attendees_tickettype', 'is_on_desk_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TicketType.is_on_desk_active'
        db.delete_column(u'attendees_tickettype', 'is_on_desk_active')
