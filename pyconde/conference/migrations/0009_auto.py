...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sections on 'SessionKind'
        m2m_table_name = db.shorten_name(u'conference_sessionkind_sections')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sessionkind', models.ForeignKey(orm[u'conference.sessionkind'], null=False)),
            ('section', models.ForeignKey(orm[u'conference.section'], null=False))
        ))
        db.create_unique(m2m_table_name, ['sessionkind_id', 'section_id'])


    def backwards(self, orm):
        # Removing M2M table for field sections on 'SessionKind'
        db.delete_table(db.shorten_name(u'conference_sessionkind_sections'))
