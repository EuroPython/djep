...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding SortedM2M table for field lightning_talks on 'SideEvent'
        db.create_table(u'schedule_sideevent_lightning_talks', (
        ...
        db.create_unique(u'schedule_sideevent_lightning_talks', ['sideevent_id', 'lightningtalk_id'])

    def backwards(self, orm):
        # Removing M2M table for field lightning_talks on 'SideEvent'
        db.delete_table(db.shorten_name(u'schedule_sideevent_lightning_talks'))
    ...
    models = {
        ...
        u'schedule.sideevent': {
            ...
            'lightning_talks': ('sortedm2m.fields.SortedManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['lightningtalks.LightningTalk']", 'null': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['conference.Location']", 'null': 'True', 'blank': 'True'}),
