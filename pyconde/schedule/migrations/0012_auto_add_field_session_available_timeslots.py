...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field available_timeslots on 'Session'
        db.create_table('schedule_session_available_timeslots', (
        ...
        db.create_unique('schedule_session_available_timeslots', ['session_id', 'timeslot_id'])


    def backwards(self, orm):
        # Removing M2M table for field available_timeslots on 'Session'
        db.delete_table('schedule_session_available_timeslots')
