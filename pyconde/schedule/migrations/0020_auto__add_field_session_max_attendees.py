...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.max_attendees'
        db.add_column(u'schedule_session', 'max_attendees',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.max_attendees'
        db.delete_column(u'schedule_session', 'max_attendees')
