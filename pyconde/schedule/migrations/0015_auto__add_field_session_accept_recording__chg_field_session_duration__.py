...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.accept_recording'
        db.add_column(u'schedule_session', 'accept_recording',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Session.duration'
        db.alter_column(u'schedule_session', 'duration_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.SessionDuration'], on_delete=models.PROTECT))

        # Changing field 'Session.conference'
        db.alter_column(u'schedule_session', 'conference_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Conference'], on_delete=models.PROTECT))

        # Changing field 'Session.speaker'
        db.alter_column(u'schedule_session', 'speaker_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['speakers.Speaker']))

        # Changing field 'Session.audience_level'
        db.alter_column(u'schedule_session', 'audience_level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.AudienceLevel'], on_delete=models.PROTECT))

        # Changing field 'Session.track'
        db.alter_column(u'schedule_session', 'track_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Track'], null=True, on_delete=models.PROTECT))

        # Changing field 'Session.kind'
        db.alter_column(u'schedule_session', 'kind_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.SessionKind'], on_delete=models.PROTECT))

    def backwards(self, orm):
        # Deleting field 'Session.accept_recording'
        db.delete_column(u'schedule_session', 'accept_recording')


        # Changing field 'Session.duration'
        db.alter_column(u'schedule_session', 'duration_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.SessionDuration']))

        # Changing field 'Session.conference'
        db.alter_column(u'schedule_session', 'conference_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Conference']))

        # Changing field 'Session.speaker'
        db.alter_column(u'schedule_session', 'speaker_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['speakers.Speaker']))

        # Changing field 'Session.audience_level'
        db.alter_column(u'schedule_session', 'audience_level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.AudienceLevel']))

        # Changing field 'Session.track'
        db.alter_column(u'schedule_session', 'track_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Track'], null=True))

        # Changing field 'Session.kind'
        db.alter_column(u'schedule_session', 'kind_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.SessionKind']))
    ...
    models = {
        ...
        u'schedule.session': {
            ...
            'kind': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['conference.SessionKind']", 'on_delete': 'models.PROTECT'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'de'", 'max_length': '5'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['conference.Location']", 'null': 'True', 'blank': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
