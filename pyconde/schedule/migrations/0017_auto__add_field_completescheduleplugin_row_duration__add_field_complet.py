...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompleteSchedulePlugin.row_duration'
        db.add_column(u'cmsplugin_completescheduleplugin', 'row_duration',
                      self.gf('django.db.models.fields.IntegerField')(default=15),
                      keep_default=False)

        # Adding field 'CompleteSchedulePlugin.merge_sections'
        db.add_column(u'cmsplugin_completescheduleplugin', 'merge_sections',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompleteSchedulePlugin.row_duration'
        db.delete_column(u'cmsplugin_completescheduleplugin', 'row_duration')

        # Deleting field 'CompleteSchedulePlugin.merge_sections'
        db.delete_column(u'cmsplugin_completescheduleplugin', 'merge_sections')
