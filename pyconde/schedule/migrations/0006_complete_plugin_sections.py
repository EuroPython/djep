...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sections on 'CompleteSchedulePlugin'
        db.create_table('schedule_completescheduleplugin_sections', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('completescheduleplugin', models.ForeignKey(orm['schedule.completescheduleplugin'], null=False)),
            ('section', models.ForeignKey(orm['conference.section'], null=False))
        ))
        db.create_unique('schedule_completescheduleplugin_sections', ['completescheduleplugin_id', 'section_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field sections on 'CompleteSchedulePlugin'
        db.delete_table('schedule_completescheduleplugin_sections')
