...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SideEvent.is_recordable'
        db.add_column('schedule_sideevent', 'is_recordable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SideEvent.is_recordable'
        db.delete_column('schedule_sideevent', 'is_recordable')
