...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.language'
        db.add_column('schedule_session', 'language',
                      self.gf('django.db.models.fields.CharField')(default='de', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.language'
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 25, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
