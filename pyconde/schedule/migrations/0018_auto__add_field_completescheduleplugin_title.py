...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompleteSchedulePlugin.title'
        db.add_column(u'cmsplugin_completescheduleplugin', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompleteSchedulePlugin.title'
        db.delete_column(u'cmsplugin_completescheduleplugin', 'title')
