...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SideEvent.video_url'
        db.add_column(u'schedule_sideevent', 'video_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SideEvent.video_url'
        db.delete_column(u'schedule_sideevent', 'video_url')
