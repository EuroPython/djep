...
urlpatterns = patterns(
    ...
    url(r'^purchase/(?P<pk>\d+)/invoice/$', 'purchase_invoice_view', name='checkin_purchase_invoice'),
    url(r'^purchase/(?P<pk>\d+)/(?P<new_state>[^/]+)/$', 'purchase_update_state', name='checkin_purchase_state'),
